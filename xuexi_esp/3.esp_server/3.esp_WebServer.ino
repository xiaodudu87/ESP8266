...
void setup(void){
 ...
 /**
  ...
  wifiMulti.addAP("ccccc", "ccc@@@123");  // 这三条语句通过调用函数addAP来记录3个不同的WiFi网络信息。
  wifiMulti.addAP("HONOR 9X", "147258369"); // 这3个WiFi网络名称分别是taichi-maker, taichi-maker2, taichi-maker3。
  wifiMulti.addAP("ccccc_5G", "ccc@@@123"); // 这3个网络的密码分别是123456789，87654321，13572468。
